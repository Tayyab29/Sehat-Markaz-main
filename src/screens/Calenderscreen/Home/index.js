...
export default function HomeC({ navigation }) {
  ...
  const [mycurrentdate, setcurrentdate] = useState(
    moment().utcOffset("+05:00").format("h:mm A")
  );
  ...
  setTimeout(() => {
    setInterval(function myFunction() {
      todoList.map((item) => {
        var date = moment().utcOffset("+05:00").format("h:mm A");
        console.log(date);
        var date2 = moment(item.alarm.time || moment(item.alarm.time)).format(
          "h:mm A"
        );
       // date2.localeCompare(date) == 0 ? setMedName(item.title) : setMedName('item.title');
        date2.localeCompare(date) == 0 ? fetchData().catch(console.error): null;
    ...
    <Fragment>
        ...
        <Task {...{ setModalVisible, isModalVisible }}>
          ...
          <View style={styles.taskContainer}>
            <TextInput
              ...
              placeholder="Medicine name and quantity"
            />
            <Text
              style={{
                fontSize: 14,
      ...
      >
        <CalendarStrip
          ...
          iconLeft={require("../../../screens/asset/left-arrow.png")}
          iconRight={require("../../../screens/asset/right-arrow.png")}
        ...
        >
          <Image
            source={require("../../../screens/asset/plus.png")}
            style={{
              height: 30,
              width: 30,
            }}
                ...
                >
                  ...
                  <View>
                    ...
                    >
                      ...
                      >
                        {moment(
                          item.alarm.time || moment(item.alarm.time)
                        ).format("h:mm A")}
                      </Text>
                      <Text
                        style={{
