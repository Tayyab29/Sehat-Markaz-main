...
import { Routes } from '../../calendernavigation';
          ...
          >
            <View style={styles.backButton}>
              ...
              >
                <Image
                  ...
                  source={require('../../../screens/asset/back.png')}
                  resizeMode="contain"
                />
              </TouchableOpacity>
            ...
            <View style={styles.taskContainer}>
              <TextInput
                ...
                value={taskText}
                placeholder="Medicine Name and Qauanity"
              />
              <Text
                style={{
                  fontSize: 14,
              ...
              <View>
                <Text style={styles.notes}>Medicine Status</Text>
                <TextInput
                  style={{
                    height: 25,
                    fontSize: 19,
